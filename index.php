...
<div class="container">
    ...
    <div class="row">
        ...
        ?>
        <!-- image -->
                <div class="card mb-5 col-6 ">
                    <div class="position-relative">
                        <!-- class imga -->
                        <img src="blogs/uploads/<?php echo $row['image']; ?>" 
                        class=" card-img-top mt-3  post-image m-6 img-fluid"
                        style="border-radius: 15px;" alt="<?php echo $row['title']; ?>">
            ...
            ?>
            <p class="alert alert-dark mr-3">Belum ada posting</p>
