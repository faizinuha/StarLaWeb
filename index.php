        ...
        ?>
            ...
            <div class="card mb-5">
              <div class="position-relative">
                <!-- class imga -->
                <img src="blogs/uploads/<?php echo $row['image']; ?>" class=" card-img-top post-image mt-4  m-7 img-fluid" style="border-radius: 10px;" alt="<?php echo $row['title']; ?>">
              ...
              <div class="card-footer text-muted d-flex justify-content-between align-items-center">
                ...
                <div class="button-container">
                  ...
                  <a href="in/download.php?gambar=<?php echo $row['image']; ?>" class="btn btn-primary"><i class="bi bi-download"></i></a>
                </div>
