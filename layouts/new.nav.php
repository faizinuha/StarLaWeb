        ...
        <ul class="navbar-nav navbar-right">
          ...
          <?php if (isset($_SESSION['username'])) { ?>
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi,<?php echo $name ?></div>
              </a>
              </a>
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="../blogs/upload.php" class="dropdown-item has-icon">
                  <i class="fas fa-bolt"></i> Uplods
                </a>
                <a href="../Private/setting.php" class="dropdown-item has-icon">
    ...
    <div class="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="dropdown">
            <a href="#" class="nav-lin"><i class="fas fa-columns"></i> <span>Layout</span></a>
